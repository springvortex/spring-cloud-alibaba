package com.zjc.admin.controller;
...
class SystemInfoControllerTest {
    ...
    private BuildProperties mockBuildProperties() {
        ...
        props.setProperty("name", "Service Admin");
        props.setProperty("version", "1.0.0");
        props.setProperty("artifact", "service-admin");
        props.setProperty("group", "com.zjc");
        props.setProperty("description", "管理端");
    ...
    void testInfoWithBuildProperties() {
        ...
        assertThat(resp.getData().getProjectName()).isEqualTo("Service Admin");
        assertThat(resp.getData().getVersion()).isEqualTo("1.0.0");
        assertThat(resp.getData().getArtifact()).isEqualTo("service-admin");
    }
