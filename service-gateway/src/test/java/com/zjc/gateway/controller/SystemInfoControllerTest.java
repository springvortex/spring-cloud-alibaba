...
class SystemInfoControllerTest {
    ...
    private BuildProperties mockBuildProperties() {
        ...
        props.setProperty("name", "Service Gateway");
        props.setProperty("version", "1.0.0");
        props.setProperty("artifact", "service-gateway");
        props.setProperty("group", "com.zjc");
        props.setProperty("description", "服务网关");
    ...
    void testInfoWithBuildProperties() {
        ...
        assertThat(resp.getData().getProjectName()).isEqualTo("Service Gateway");
        assertThat(resp.getData().getVersion()).isEqualTo("1.0.0");
        assertThat(resp.getData().getArtifact()).isEqualTo("service-gateway");
    }
